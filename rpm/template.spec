...
%global pkg_name joint_group_impedance_controller
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-jazzy-joint-group-impedance-controller
Version:        2.0.0
Release:        1%{?dist}
...
%description
Controller for modifying impedance (stiffness and damping) interfaces of a joint
group
...
%changelog
* Thu Jul 16 2026 Aron Svastits <svastits1@gmail.com> - 2.0.0-1
